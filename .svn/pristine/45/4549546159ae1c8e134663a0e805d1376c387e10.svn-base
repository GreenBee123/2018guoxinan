...
<%
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
			+ path + "/";
%>
 <s:action name="adAction_getAllByPage" namespace="/" executeResult="false"/>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <s:iterator var="ad" value="#request.ads">
							<tr>
								...
								<td class="center"><s:property value="#ad.adName" /></td>
								<td class="center"><s:property value="#ad.adPwd" /></td>
								<td class="center">
									<a class="btn btn-success" href="Ad/add.jsp?ad.adID=<s:property value='#ad.adID'/>">
										<i class="icon-zoom-in "></i>  
									</a>
									<a class="btn btn-info" href="Ad/update.jsp?ad.adID=<s:property value='#ad.adID'/>">
										<i class="icon-edit "></i>  
									</a>
									<a class="btn btn-danger" href="adAction_delete.action?ad.adID=<s:property value='#ad.adID'/>">
