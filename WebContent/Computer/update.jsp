...
<jsp:include page="../sidebar.jsp"/>			
				...
				<div class="box span12">
					<div class="box-header">
						...
						<div class="box-icon">
							...
							<form class="form-horizontal" action="computerAction_update.action" method="post">
							<fieldset>

							  <div class="control-group">
								<label class="control-label" for="focusedInput">ID</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" value="${computer.cID}" name="computer.cID"/>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">电脑品牌</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" value="${computer.cBrand}" name="computer.cBrand"/>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">电脑型号</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text"  value="${computer.cModel}" name="computer.cModel"/>
								</div>
							  </div>
		...
		<footer>
			<p>
				<span style="text-align:left;float:left">Copyright &copy; 2014.Company name All rights reserved.More Templates <a href="http://localhost:8080/PcDo/"  title="">返回主页</a> - Collect from <a href="http://localhost:8080/PcDo/Computer/Computer.jsp" title="主页" >返回当前主页</a></span>
			</p>
