						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <s:iterator var="computer" value="#request.computers">
							<tr>
								...
								<td class="center"><s:property value="#computer.cBrand" /></td>
								<td class="center"><s:property value="#computer.cModel" /></td>

								<td class="center">
									<a class="btn btn-success" href="Computer/add.jsp?computer.cID=<s:property value='#computer.cID'/>">
										<i class="icon-zoom-in "></i>  
									</a>
									<a class="btn btn-info" href="Computer/update.jsp?computer.cID=<s:property value='#computer.cID'/>">
										<i class="icon-edit "></i>  
									</a>
									<a class="btn btn-danger" href="ComputerAction_delete.action?computer.cID=<s:property value='#computer.cID'/>">
